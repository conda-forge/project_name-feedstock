...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/project_name-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13746&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/project_name-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `project_name` can be installed with:

```
conda install project_name
```

It is possible to list all of the versions of `project_name` available on your platform with:
